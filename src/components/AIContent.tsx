...
const Heading = ({ children, gradient = false, className = "" }: { children: React.ReactNode, gradient?: boolean, className?: string }) => (
  <motion.h2
    ...
    whileInView={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.8 }}
    className={`slide-heading mb-4 md:mb-6 ${gradient ? 'text-gradient' : ''} ${className}`}
    style={{ fontSize: "clamp(1.3rem, 2.8vw, 3.2rem)" }}
  >
    {children}
  </motion.h2>
);
...
const SubHeading = ({ children, className = "" }: { children: React.ReactNode, className?: string }) => (
  ...
  >
    <div className="slide-subheading-line" />
    <span
      className="text-brand-cyan font-bold tracking-[0.3em] uppercase"
...
// ─── Slide 2: How AI is Shaping Healthcare ───────────────────────────────────
export const AIShapingHealthcare = () => {
  const roles = [
    {
      icon: TrendingUp,
  ...
  return (
    <Container>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-center">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3 xl:gap-5">
          {roles.map((role, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br from-white/5 via-white/5 to-white/5 group-hover:from-brand-blue group-hover:to-brand-cyan transition-all duration-500 rounded-2xl" />
              <div
                className="relative bg-dark-surface/95 rounded-2xl flex flex-col h-full z-10 border border-white/5"
                style={{ padding: "clamp(0.9rem, 1.5vw, 1.75rem)" }}
              >
                <div
                  className="rounded-xl bg-brand-cyan/10 text-brand-cyan flex items-center justify-center border border-brand-cyan/20 group-hover:bg-brand-cyan group-hover:text-black transition-all duration-500 shrink-0"
                  style={{
                    width: "clamp(2rem, 3vw, 3rem)",
                    height: "clamp(2rem, 3vw, 3rem)",
                    marginBottom: "clamp(0.6rem, 1vw, 1.2rem)",
                  }}
                >
                  <role.icon style={{ width: "clamp(0.9rem, 1.3vw, 1.4rem)", height: "clamp(0.9rem, 1.3vw, 1.4rem)" }} />
                </div>
                <h3
                  className="font-bold group-hover:text-brand-cyan transition-colors duration-300"
                  style={{
                ...
                <p
                  className="text-white/50 leading-relaxed font-light grow"
                  style={{ fontSize: "clamp(0.7rem, 0.95vw, 1.05rem)" }}
                >
                  {role.desc}
                </p>
              </div>
...
// ─── Slide 3: Key Real-World Applications ────────────────────────────────────
export const AIKeyApplications = () => {
  const apps = [
    {
      title: "Drug Discovery",
  ...
  return (
    <Container>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-center">
        {/* Left Column */}
        <div className="lg:col-span-7 flex flex-col gap-3 xl:gap-4">
          {apps.map((app, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, x: -20 }}
              ...
              transition={{ delay: i * 0.08 }}
              className="flex gap-4 p-4 rounded-xl hover:bg-white/3 border border-transparent hover:border-white/5 transition-all duration-300 group"
              style={{ padding: "clamp(0.7rem, 1.1vw, 1.3rem)" }}
            >
              <div
                className="text-brand-cyan font-mono font-bold shrink-0 mt-0.5"
              ...
              <div>
                <h4
                  className="font-bold text-white group-hover:text-brand-cyan transition-colors"
                  style={{ fontSize: "clamp(0.8rem, 1.2vw, 1.3rem)" }}
                >
                  {app.title}
                </h4>
                <p
                  className="text-white/50 font-light mt-1 leading-relaxed"
                  style={{ fontSize: "clamp(0.7rem, 0.95vw, 1.05rem)" }}
                >
                  {app.desc}
                </p>
        ...
        <div className="lg:col-span-5 flex flex-col gap-5 xl:gap-6">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-brand-blue/40 to-brand-cyan/40" />
            <div
              className="relative bg-black/95 rounded-2xl flex flex-col gap-4 border border-white/5 z-10"
              style={{ padding: "clamp(0.9rem, 1.5vw, 1.75rem)" }}
            >
              <div className="flex items-center gap-2 text-brand-cyan">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col border-r border-white/10 pr-2">
                  <span
                    ...
                    style={{ fontSize: "clamp(1.4rem, 2.5vw, 3rem)" }}
                  >
                    95%
                  </span>
                  <span
                    className="text-white/55 leading-tight mt-1"
                    style={{ fontSize: "clamp(0.6rem, 0.8vw, 0.9rem)" }}
                  >
                    Healthcare leaders expect GenAI transformation.
                  </span>
                </div>
                <div className="flex flex-col pl-2">
                  <span
                  ...
                  <span
                    ...
                    style={{ fontSize: "clamp(0.6rem, 0.8vw, 0.9rem)" }}
                  >
                    Already realizing ROI within 1 year of deployment.
                  </span>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 xl:gap-4">
        {letters.map((item, i) => (
          <motion.div
            ...
            transition={{ delay: i * 0.08 }}
            whileHover={{ y: -8, scale: 1.03 }}
            className="group bg-dark-surface/90 rounded-2xl border border-white/5 flex flex-col h-full transition-all duration-300 hover:border-brand-cyan/20 hover:shadow-[0_0_25px_rgba(0,223,216,0.08)] cursor-pointer"
            style={{ padding: "clamp(0.8rem, 1.3vw, 1.5rem)" }}
          >
            <div
              className={`rounded-xl bg-linear-to-br ${item.color} flex items-center justify-center font-black text-white shadow-lg shrink-0`}
              style={{
                width: "clamp(2rem, 3vw, 3.5rem)",
                height: "clamp(2rem, 3vw, 3.5rem)",
                fontSize: "clamp(0.9rem, 1.5vw, 1.75rem)",
                marginBottom: "clamp(0.6rem, 1vw, 1.1rem)",
              }}
            >
              {item.letter}
            </div>
            ...
            <h4
              className={`font-black uppercase tracking-wider mb-2 ${item.accent}`}
            ...
            <p
              className="text-white/40 leading-relaxed font-light grow group-hover:text-white/80 transition-colors"
...
export const AIDataAlgorithmicFailures = () => {
  ...
  return (
    <Container>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-center">
        {/* Left Column */}
        <div className="lg:col-span-7 flex flex-col gap-4 xl:gap-5">
          {failures.map((fail, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: i * 0.1 }}
              className="flex gap-4 rounded-2xl bg-white/3 border border-white/5 hover:bg-white/5 hover:border-brand-blue/30 transition-all duration-300 group"
              style={{ padding: "clamp(0.9rem, 1.4vw, 1.6rem)" }}
            >
              <div
                className="rounded-xl bg-red-500/10 text-red-400 flex items-center justify-center shrink-0 border border-red-500/20 group-hover:bg-red-500 group-hover:text-black transition-all duration-500"
                style={{
                  width: "clamp(2rem, 3vw, 3rem)",
                  height: "clamp(2rem, 3vw, 3rem)",
                }}
              >
                <fail.icon style={{ width: "clamp(0.9rem, 1.3vw, 1.4rem)", height: "clamp(0.9rem, 1.3vw, 1.4rem)" }} />
              </div>
              <div>
                <h3
                  className="font-bold text-white group-hover:text-brand-cyan transition-colors"
                ...
                <p
                  className="text-white/55 font-light mt-1.5 leading-relaxed"
                  style={{ fontSize: "clamp(0.7rem, 0.95vw, 1.05rem)" }}
                >
                  {fail.desc}
                </p>
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          <div className="relative bg-linear-to-r from-red-950/30 to-red-900/10 rounded-2xl border border-red-500/20 text-center"
            style={{ padding: "clamp(0.9rem, 1.4vw, 1.6rem)" }}
          >
            <span
              className="font-serif text-red-500/40 block mb-1"
              style={{ fontSize: "clamp(1.5rem, 2.5vw, 3rem)" }}
            >"</span>
            <p
              className="text-red-200 font-medium italic leading-relaxed"
              style={{ fontSize: "clamp(0.72rem, 1.05vw, 1.15rem)" }}
            >
              &quot;Garbage in, garbage out&quot; is not an academic minor warning when lives are at stake.
            </p>
            <span
              className="font-serif text-red-500/40 block leading-none mt-2"
              style={{ fontSize: "clamp(1.5rem, 2.5vw, 3rem)" }}
            >"</span>
          </div>
        </div>
    ...
    <Container>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          <div
            className="rounded-xl bg-orange-950/20 border border-orange-500/20 flex gap-3 items-start"
            style={{ padding: "clamp(0.7rem, 1.1vw, 1.3rem)" }}
          >
            <AlertTriangle
              className="text-orange-400 shrink-0 mt-0.5"
              style={{ width: "clamp(0.9rem, 1.3vw, 1.4rem)", height: "clamp(0.9rem, 1.3vw, 1.4rem)" }}
            />
            <p
              className="text-orange-300/80 leading-relaxed font-light"
              style={{ fontSize: "clamp(0.65rem, 0.95vw, 1.05rem)" }}
            >
              Without active mitigation, advanced medical AI risks creating a{" "}
              <span className="font-bold text-orange-400">two-tiered healthcare system</span>{" "}
              where elite institutions benefit from AI co-pilots while resource-limited settings are left behind.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3 xl:gap-5">
          {barriers.map((bar, i) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: i * 0.08 }}
              className="rounded-2xl bg-white/3 border border-white/5 hover:border-orange-500/30 transition-all duration-300 group flex flex-col h-full"
              style={{ padding: "clamp(0.9rem, 1.4vw, 1.6rem)" }}
            >
              <div
                className="text-orange-400 font-mono font-bold mb-2"
                style={{ fontSize: "clamp(0.6rem, 0.85vw, 0.95rem)" }}
              >
                BARRIER 0{i + 1}
              </div>
              <h4
                className="font-bold text-white mb-2 group-hover:text-brand-cyan transition-colors"
                style={{ fontSize: "clamp(0.8rem, 1.2vw, 1.3rem)" }}
              >
                {bar.title}
              </h4>
              <p
                className="text-white/50 leading-relaxed font-light grow"
                style={{ fontSize: "clamp(0.68rem, 0.95vw, 1.05rem)" }}
              >
                {bar.desc}
              </p>
            </motion.div>
...
export const AITechnicalMitigations = () => {
  ...
  return (
    <Container>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 xl:gap-6">
        {solutions.map((item, i) => (
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: i * 0.1 }}
            className={`rounded-2xl bg-gradient-to-br ${item.gradient} border border-white/5 ${item.border} transition-all duration-500 flex flex-col justify-between`}
            style={{ padding: "clamp(1rem, 1.6vw, 2rem)" }}
          >
            <div>
              <div className="flex justify-between items-center mb-3">
                <span
                  className="text-white/40 tracking-wider uppercase font-mono"
              ...
              <h3
                ...
                style={{ fontSize: "clamp(0.85rem, 1.3vw, 1.45rem)" }}
              >
                {item.solution}
              </h3>
              <p
      ...
      <div
        className="mt-5 text-center text-brand-cyan/60 font-mono"
        style={{ fontSize: "clamp(0.58rem, 0.8vw, 0.9rem)" }}
      >
        [REASSESSMENT REQUIRED] Automated Drift & Compliance Audits Enabled
      </div>
  ...
  return (
    <Container>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          <div className="space-y-4">
            {[
              {
                icon: BookOpen,
                iconBg: "bg-brand-cyan/10 text-brand-cyan border-brand-cyan/20",
                title: "Mandatory AI Literacy Programs",
                desc: "Establish certified education paths for nurses, pharmacists, and surgeons to understand decision outputs and confidently spot algorithmic errors."
              },
              {
                icon: Users,
                iconBg: "bg-brand-blue/10 text-brand-blue border-brand-blue/20",
                title: "Ethical Leadership Oversight",
                desc: "Appoint a Chief AI Officer and form independent oversight boards to review software metrics, verify fairness, and govern deployment guidelines."
              }
            ].map((item, i) => (
              <div key={i} className="flex gap-4 items-start">
                <div
                  className={`rounded-lg ${item.iconBg} flex items-center justify-center shrink-0 border`}
                  style={{
                    width: "clamp(1.8rem, 2.5vw, 2.8rem)",
                    height: "clamp(1.8rem, 2.5vw, 2.8rem)",
                  }}
                >
                  <item.icon style={{ width: "clamp(0.8rem, 1.1vw, 1.2rem)", height: "clamp(0.8rem, 1.1vw, 1.2rem)" }} />
                </div>
                <div>
                  <h4
          ...
          <p
            className="text-brand-cyan/80 font-mono italic"
            style={{ fontSize: "clamp(0.62rem, 0.9vw, 1rem)" }}
          >
            &quot;AI should operate as a supportive co-pilot, not an autopilot. The licensed human provider always stays in charge.&quot;
          </p>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          <h4
            className="font-black uppercase tracking-widest text-brand-cyan mb-2 font-mono"
            style={{ fontSize: "clamp(0.6rem, 0.85vw, 0.95rem)" }}
          >
            Confidence-Based Escalation Flow
          </h4>
          ...
          <div className="flex flex-col gap-4">
            {steps.map((step, i) => (
              <div key={i} className="flex gap-4 items-stretch group">
                <div className="flex flex-col items-center shrink-0" style={{ width: "clamp(2rem, 3vw, 3rem)" }}>
                  <div
                    className="rounded-full bg-black border-2 border-white/10 flex items-center justify-center font-mono text-white/40 shrink-0 z-10 transition-colors duration-500 group-hover:border-brand-cyan/50 group-hover:text-brand-cyan"
                    style={{
                      width: "clamp(2rem, 3vw, 3rem)",
                      height: "clamp(2rem, 3vw, 3rem)",
                ...
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ delay: i * 0.15 }}
                  className="relative flex-1 min-w-0 rounded-2xl bg-white/3 border border-white/5 hover:border-brand-blue/35 transition-all duration-300 group"
                  style={{ padding: "clamp(0.8rem, 1.3vw, 1.5rem)" }}
                >
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span
                      className={`px-2.5 py-0.5 rounded-full border font-black uppercase tracking-wider ${step.color}`}
                      style={{ fontSize: "clamp(0.55rem, 0.75vw, 0.85rem)" }}
                    >
                      {step.level}
                    </span>
                    <h5
                      className="font-bold text-white"
                      style={{ fontSize: "clamp(0.78rem, 1.1vw, 1.2rem)" }}
                    >
                      {step.action}
                    </h5>
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-center">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3 xl:gap-5">
          {steps.map((step, i) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              transition={{ delay: i * 0.1 }}
              className="rounded-2xl bg-white/3 border border-white/5 hover:bg-white/5 hover:border-brand-blue/35 transition-all duration-300 group flex flex-col h-full"
              style={{ padding: "clamp(0.9rem, 1.4vw, 1.6rem)" }}
            >
              <div
                className="rounded-lg bg-brand-cyan/15 text-brand-cyan flex items-center justify-center font-bold border border-brand-cyan/20 shrink-0"
                style={{
                  width: "clamp(1.8rem, 2.5vw, 2.8rem)",
                  height: "clamp(1.8rem, 2.5vw, 2.8rem)",
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          <div className="relative p-[1.5px] rounded-2xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-brand-cyan/40 to-brand-blue/40" />
            <div
              className="relative bg-black/95 rounded-2xl border border-white/5 z-10 flex flex-col items-center text-center"
              style={{ padding: "clamp(0.9rem, 1.4vw, 1.6rem)" }}
            >
              <span
                className="font-mono uppercase tracking-widest text-brand-cyan mb-2"
                style={{ fontSize: "clamp(0.58rem, 0.8vw, 0.9rem)" }}
              >
                Equity Integration
              </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-10 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col gap-3 xl:gap-4">
          {commitments.map((item, i) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ delay: i * 0.08 }}
              className="flex gap-4 items-start rounded-xl bg-white/3 border border-white/5 hover:bg-white/5 hover:border-brand-blue/35 transition-all duration-300 group"
              style={{ padding: "clamp(0.7rem, 1.1vw, 1.3rem)" }}
            >
              <div
                className="rounded-full bg-brand-cyan/20 border border-brand-cyan/40 text-brand-cyan flex items-center justify-center shrink-0 font-bold font-mono group-hover:bg-brand-cyan group-hover:text-black transition-colors duration-300 mt-0.5"
                style={{
                  width: "clamp(1.5rem, 2vw, 2.2rem)",
                  height: "clamp(1.5rem, 2vw, 2.2rem)",
              ...
              <div>
                ...
                <p
                  className="text-white/50 font-light mt-0.5 leading-relaxed"
                  style={{ fontSize: "clamp(0.68rem, 0.95vw, 1.05rem)" }}
                >
                  {item.desc}
                </p>
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-brand-cyan/40 to-brand-blue/40" />
            <div
              className="relative bg-black/95 rounded-2xl border border-white/5 z-10 flex flex-col gap-3"
              style={{ padding: "clamp(0.9rem, 1.5vw, 1.75rem)" }}
            >
              <span
                className="font-serif text-brand-cyan leading-none"
                style={{ fontSize: "clamp(1.5rem, 2.5vw, 3rem)" }}
              >
                &ldquo;
              </span>
              <p
                className="text-white/90 font-medium italic leading-relaxed text-center"
                style={{ fontSize: "clamp(0.78rem, 1.2vw, 1.35rem)" }}
              >
                AI will revolutionize healthcare – but only if we lead with ethics, equity, and evidence.
              </p>
              <span
                className="font-serif text-brand-cyan leading-none text-right"
                style={{ fontSize: "clamp(1.5rem, 2.5vw, 3rem)" }}
              >
                &rdquo;
              </span>
